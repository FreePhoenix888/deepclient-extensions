...
import { TransitionDeleteType, TransitionInsertType, TransitionType, TransitionUpdateType } from "./transition";
...
export type SerialAction = InsertSerialAction | UpdateSerialAction | DeleteSerialAction;