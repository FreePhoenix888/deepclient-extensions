import { DeepClientInstance, Table } from "@deep-foundation/deeplinks/imports/client";
...
import { deleteMutation, insertMutation, updateMutation } from "@deep-foundation/deeplinks/imports/gql";
