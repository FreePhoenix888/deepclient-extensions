...
import {createSerialTransitionsBuilderDecorator,CreateTransitionBuilderDecoratorOptions,SerialTransitionsBuilderDecorator} from '../src/serial-transitions-builder/create-serial-transitions-builder-decorator.js'
